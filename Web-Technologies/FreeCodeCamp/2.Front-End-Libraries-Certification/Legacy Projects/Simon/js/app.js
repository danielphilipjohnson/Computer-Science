...
function Simon() {
  ...
  this.setTimeStep = function (sequenceLength) {
    ...
    if (sequenceLength < 4) return tSteps[0];
    if (sequenceLength < 8) return tSteps[1];
    if (sequenceLength < 12) return tSteps[2];
    return tSteps[3];
  };
