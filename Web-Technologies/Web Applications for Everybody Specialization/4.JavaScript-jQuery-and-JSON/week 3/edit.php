   ...
   if (validatePos() === true) {
       ...
       if (validateEdu() === true) {
           ...
           if ($validateProfile[0] === true) {
               ...
               deleteEducationEntries($dbh, $_REQUEST['profile_id']);

               insertEducationIntoProfile($dbh, $_GET['profile_id']);
...
<body>
   <div class="container">
       ...
       $education = getUsersEducation($dbh, $_GET['profile_id']);
           ...
           <div id="edu_fields">
               ...
               foreach ($education as $school) :  ?>
                   ...
                   <div id=<?= "edu" . $educationCount ?>>
                       <p>Year:
                           <input type="text" name=<?= "edu_year" . $educationCount ?> value=<?= $school['year'] ?>>
                           <input type="button" value="-" onclick=<?= "$('#edu" . $educationCount . "'" . ").remove();return false;" ?>>
                       </p>
                       <p>School:
                           <input type="text" size="80" name=<?= "edu_school" . $educationCount ?> class="school ui-autocomplete-input" autocomplete="off" value="<?= $school['name'] ?>">
                       </p>
                   </div>
   ...
   <script>
       ...
       <?php
            echo "countPos =  " . $positionCount;
       ?>;
       <?php
            echo "countEdu =  " . $educationCount;
       ?>;
           ...
           $('#addEdu').click(function(event) {
               ...
               $('#edu_fields').append(
                   '<div id="edu' + countEdu + '"> \
                    ...
                    <p>School: <input type="text" size="80" name="edu_school' + countEdu + '" class="school ui-autocomplete-input" value="" autocomplete="off" />\
                    </p></div>'
               );
