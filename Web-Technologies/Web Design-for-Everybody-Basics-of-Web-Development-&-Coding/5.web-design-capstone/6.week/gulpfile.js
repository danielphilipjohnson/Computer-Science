...
function developmentBuildHTML() {
  return src("src/pug/**/*.pug").pipe(pug()).pipe(dest("src/"));
}
...
/** BUILD SECTION */
function cleanBuild() {
  return src("build/public/", { read: false }).pipe(clean());
}
...
function generateJSdoc(cb) {
  return src(["README.md", "src/js/**/*.js"], { read: false }).pipe(jsdoc(cb));
  cb();
}
...
if (process.env.NODE_ENV === "production") {
  ...
  exports.devJS = series(
    fetchDependencies,
    developmentConcatJS,
    developmentJSValidate
  );

  exports.validate = series(
    developmentHtmlValidate,
    CSSValidate,
    developmentJSValidate
  );
