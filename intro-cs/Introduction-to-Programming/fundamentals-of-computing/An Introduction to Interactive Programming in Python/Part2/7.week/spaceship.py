...
def rock_spawner():
    ...
    a_rock = Sprite(
        ...
        [random.choice([0.5, -1]) * random.random()
         * 2,random.choice([0.5, -1])
         * random.random() * 2] , 1,
        random.choice([0.5, -1])
        * 0.05, asteroid_image, asteroid_info)
...
a_rock = Sprite([WIDTH / 3, HEIGHT / 3], [0.7, 0.9], 0, 0.05, asteroid_image, asteroid_info)
